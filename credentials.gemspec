...
Gem::Specification.new do |s|
  ...
  s.files = ["generators/credentials/credentials_generator.rb", "generators/credentials/USAGE", "History.txt", "init.rb", "install.rb", "lib/credentials/actor.rb", "lib/credentials/class_methods.rb", "lib/credentials/inflector.rb", "lib/credentials/rulebook.rb", "lib/credentials/rules/can.rb", "lib/credentials/rules/cannot.rb", "lib/credentials/rules/rule.rb", "lib/credentials.rb", "LICENSE", "Manifest.txt", "Rakefile", "README.rdoc", "uninstall.rb"]
  s.has_rdoc = true
